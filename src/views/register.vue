    ...
    export default {
        ...
        methods: {
            ...
            validate() {
                ...
                let validate4 = this.validateUser();
            ...
            doregister(){
                if (this.validate()) {
                    axios.post("http://localhost:8090/bangumi/user/register", {
                        email: this.email,
